...
// Router настраивает HTTP маршруты и middleware
type Router struct {
...
// Setup настраивает и возвращает HTTP роутер
...
// setupGlobalMiddleware настраивает глобальные middleware
...
func (rt *Router) setupProtectedRoutes(r *chi.Mux) {
	r.Route("/api/user", func(r chi.Router) {
		...
		r.Post("/balance/withdraw", rt.userHandler.WithdrawBalance)
